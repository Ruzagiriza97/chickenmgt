...
public class User {
    ...
    public User(Long id, String username, String email, String password, Set<Role> roles, Village village) {
        this.id = id;
    ...
    public static class UserBuilder {
        ...
        public User build() {
            return new User(id, username, email, password, roles, village);
        }
    }
}
